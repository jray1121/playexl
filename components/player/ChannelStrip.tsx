...
export default function ChannelStrip({ track, index, baseColor, onVolumeChange, onSoloToggle, hideSolo }: Props) {
  ...
  return (
    <div
      className="relative h-full pl-4 pr-5 py-2 flex flex-col gap-1.5 justify-center border-b border-[#afbccc] transition-all duration-200 bg-white"
    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        <div className="relative flex-1 h-5 flex items-center">
          {/* Groove */}
          <div className="absolute inset-x-0 h-1 rounded-full bg-slate-400" />
          {/* Fill */}
          <div
          ...
          {/* Thumb */}
          <div
            className="absolute w-3.5 h-3.5 rounded-full bg-white border-2 shadow pointer-events-none transition-none"
            style={{
