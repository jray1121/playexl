  ...
  if (!loaded) {
    return (
      <div className="flex flex-col items-center justify-center h-[80vh] gap-4">
        ...
        <div className="w-64 h-1.5 bg-[#b8c5d4] rounded-full overflow-hidden">
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-56px)]">
      ...
      <div className="flex flex-1 min-h-0 relative">
        ...
        {/* ── Left control panel ─────────────────────────────────────────────── */}
        <div className="w-64 border-r-2 border-[#aab6c9] bg-[#b8c5d4] flex flex-col shrink-0">
          ...
          {beatMap.length > 0 && (
            <div className="px-4 pb-2 shrink-0 flex items-center gap-2">
              ...
              <input
                ...
                placeholder="1"
                className="w-14 bg-white border border-[#aab6c9] rounded-lg px-2 py-1 text-sm text-zinc-800 focus:outline-none focus:border-brand tabular-nums text-center"
              />
              <button
          ...
          {(isVoctave || song.allow_export) && <div className="px-4 py-3 border-t border-slate-200 shrink-0 flex flex-col gap-2">
            ...
            {/* Mode toggle */}
            <div className="flex rounded-lg overflow-hidden border border-[#aab6c9]">
              <button
          ...
          <div className="px-4 pb-3 shrink-0">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="w-6 h-6 rounded bg-[#b8c5d4] hover:bg-[#b8c5d4] text-zinc-700 flex items-center justify-center text-lg leading-none transition-colors"
              >−</button>
        ...
        {/* ── Mixer (right panel) ───────────────────────────────────────────────── */}
        <div className="w-64 border-l-2 border-[#aab6c9] bg-[#b8c5d4] overflow-hidden flex flex-col shrink-0">
          {/* Mixer header */}
          <div className="pl-4 pr-5 pt-2.5 pb-2 border-b border-slate-200 shrink-0">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={resetMixer}
                className="text-[10px] font-semibold text-zinc-500 hover:text-zinc-800 bg-[#b8c5d4] hover:bg-[#b8c5d4] px-2 py-0.5 rounded transition-colors"
              >Reset</button>
            </div>
          </div>
          ...
          {trackUIs.filter((t) => t.part.name === "full_mix").map((track) => {
            ...
            return (
              <div key="full_mix" className="shrink-0 h-16 border-b border-[#aab6c9]">
